describe('Push Notifications', () => {
    it('Granted', () => {
        ...
        cy.get('.notifications[data-status="granted"]').click({ force: true }).should(() => {
    ...
    it('Default', () => {
        cy.visit('http://localhost:3000');
        cy.clearLocalStorage();
        cy.get('.notifications[data-status="default"]').click({ force: true }).should(() => {
    ...
    it('Denied', () => {
        cy.visit('http://localhost:3000');
        cy.clearLocalStorage();
        cy.get('.notifications[data-status="denied"]').click({ force: true }).should(() => {
