describe('Push Notifications', () => {
    it('Granted', () => {
        ...
        cy.get('.notifications[data-status="granted"]').click({ force: true }).then(() => {
    ...
    it('Default', () => {
        cy.visit('http://localhost:3000');
        cy.get('.notifications[data-status="default"]').click({ force: true }).then(() => {
    ...
    it('Denied', () => {
        cy.visit('http://localhost:3000');
        cy.get('.notifications[data-status="denied"]').click({ force: true }).then(() => {
